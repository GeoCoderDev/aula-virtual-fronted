                ...
                {allData.map((item, index) => (
                  <tr key={item.id} className={`border-b-[0.1rem] border-black ${index === allData.length - 1 ? 'w-full' : ''}`}>
                    ...
                    <td className="py-4 flex items-center justify-center gap-x-8" style={{ ...cellStyle, borderLeft: 'none', borderRight: 'none' }}> {/* Separación adicional de 4 */}
                      <button
                        type="button"
                        className="text-white bg-rojo-orange rounded-[0.5rem] py-2 px-4 font-semibold text-[0.9rem] disabled:grayscale-[0.5]"
                      >
                        Registrar
                      </button>
                      <button
                        type="button"
                        className="text-white bg-amarillo-pooh rounded-[0.5rem] py-2 px-4 font-semibold text-[0.9rem] disabled:grayscale-[0.5]"
                      >
                        Editar
                      </button>
                      <button
