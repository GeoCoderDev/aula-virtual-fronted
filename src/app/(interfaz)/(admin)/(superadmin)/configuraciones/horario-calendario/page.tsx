  ...
  return (
    <div className="flex flex-col items-start justify-center w-full">
        ...
        <div className="flex items-center mt-4 pt-4">
          <div className="flex-1">
            <div className="flex items-center space-x-4">
              ...
              <button className="button-with-loader ml-4">
      ...
      <div className="mb-6 p-4 bg-white  rounded w-full">
        ...
        <p className=" mt-2 border-t pt-2">Establece los días de la semana en los que se impartirán clases. Normalmente, las instituciones educativas tienen clases de lunes a viernes, pero puedes seleccionar los días específicos según tus necesidades.</p>
      ...
      <div className="mb-6 p-4 bg-white  rounded w-full">
        ...
        <div className="flex items-center mt-4 pt-4">
          <p className="flex-1 ">Duración: 45 Minutos</p>
          <button className="button-with-loader">
            Modificar <EditarIcon /> 
          </button>
        </div>
      ...
      <div className="mb-6 p-4 bg-white rounded w-full">
        ...
        <p className=" mt-2 border-t pt-2">Establece la duración de cada hora académica o período de clase. La duración de la hora académica es un factor clave para garantizar el cumplimiento de los requisitos de horas lectivas y la correcta planificación de los horarios de clase.</p>
        <div className="flex items-center mt-4 pt-4">
          <p className="flex-1 ">Duración: 15 Minutos</p>
          <button className="button-with-loader">
            Modificar <EditarIcon /> 
          </button>
        </div>
        ...
        {/* Agregar Recreo */}
        <div className="mt-4 bg-verde-spotify bg-opacity-5 rounded-lg border-4 border-verde-spotify p-4">
          {[
            { id: 1, time: '11:00 - 11:15' },
            { id: 2, time: '16:25 - 16:40' },
          ].map(recreo => (
            <div key={recreo.id} className="flex items-center justify-between p-2 rounded mb-2">
              <p>Recreo {recreo.id}: {recreo.time}</p>
              <div className="flex space-x-2">
                <button className="px-2 py-2 bg-verde-spotify text-white rounded flex items-center">
                  <EditarIcon className="ml-1 mr-1" />
                  {/* Botón Editar */}
                </button>
                <button className="px-2 py-2 bg-rojo-orange text-white rounded flex items-center">
